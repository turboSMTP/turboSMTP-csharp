...
namespace API.TurboSMTP.Test.Api
{
    ...
    public class BillingApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test BuyEmailValidatorCredits
        /// </summary>
        [Fact]
        public void BuyEmailValidatorCreditsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //BuyEmailValidatorCreditsRequest buyEmailValidatorCreditsRequest = null;
            //var response = instance.BuyEmailValidatorCredits(buyEmailValidatorCreditsRequest);
            //Assert.IsType<BuyEmailValidatorCreditsSucessResponse>(response);
        }
    }
}
