...
namespace API.TurboSMTP.Test.Api
{
    ...
    public class EmailValidatorApiTests : IDisposable
    {
        ...
        public void DeleteEmailValidationListByIdTest()
        {
            ...
            //Assert.IsType<EmailValidatorListDeleteSuccess>(response);
        }
        ...
        public void GetEmailValidationListsTest()
        {
            ...
            //int? limit = null;
            //string tz = null;
            //var response = instance.GetEmailValidationLists(from, to, page, limit, tz);
        ...
        public void GetValidatedEmailsByListTest()
        {
            ...
            //int? page = null;
            //int? limit = null;
            //var response = instance.GetValidatedEmailsByList(id, page, limit);
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //EmailAddressRequestBody emailAddressRequestBody = null;
            //var response = instance.ValidateEmail(emailAddressRequestBody);
