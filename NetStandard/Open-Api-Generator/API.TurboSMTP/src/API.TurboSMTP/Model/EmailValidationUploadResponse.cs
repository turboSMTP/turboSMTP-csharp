...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmailValidationUploadResponse")]
    public partial class EmailValidationUploadResponse
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailValidationUploadResponse" /> class.
        /// </summary>
        /// <param name="listId">List Identifier.</param>
        /// <param name="totalEmails">Total emails found in uploaded file.</param>
        public EmailValidationUploadResponse(int listId = default(int), int totalEmails = default(int))
        {
            this.ListId = listId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailValidationUploadResponse {\n");
