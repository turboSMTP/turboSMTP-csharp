...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmailValidatorMailSharedDetails")]
    public partial class EmailValidatorMailSharedDetails
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailValidatorMailSharedDetails" /> class.
        /// </summary>
        ...
        public EmailValidatorMailSharedDetails(StatusEnum? status = default(StatusEnum?), SubStatusEnum? subStatus = default(SubStatusEnum?), bool freeEmail = default(bool), string domain = default(string), int? domainAgeDays = default(int?), string smtpProvider = default(string), bool mxFound = default(bool), string mxRecord = default(string))
        {
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailValidatorMailSharedDetails {\n");
