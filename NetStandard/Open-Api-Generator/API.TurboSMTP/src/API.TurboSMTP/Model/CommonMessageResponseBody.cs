...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommonMessageResponseBody")]
    public partial class CommonMessageResponseBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonMessageResponseBody" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        public CommonMessageResponseBody(string message = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommonMessageResponseBody {\n");
