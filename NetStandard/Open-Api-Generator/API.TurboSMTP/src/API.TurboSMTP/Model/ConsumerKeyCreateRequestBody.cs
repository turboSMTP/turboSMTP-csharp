...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConsumerKeyCreateRequestBody")]
    public partial class ConsumerKeyCreateRequestBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsumerKeyCreateRequestBody" /> class.
        /// </summary>
        /// <param name="label">Consumer Key label..</param>
        public ConsumerKeyCreateRequestBody(string label = default(string))
        {
            this.Label = label;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConsumerKeyCreateRequestBody {\n");
