...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CommmonResultResponseBody")]
    public partial class CommmonResultResponseBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommmonResultResponseBody" /> class.
        /// </summary>
        /// <param name="result">result.</param>
        public CommmonResultResponseBody(bool result = default(bool))
        {
            this.Result = result;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommmonResultResponseBody {\n");
