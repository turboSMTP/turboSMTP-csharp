...
namespace API.TurboSMTP.Model
{
    ...
    public partial class AuthorizationError
    {
        ...
        {
            /// <summary>
            /// Enum MissingAuthorizationKey for value: missing_authorization_key
            /// </summary>
            [EnumMember(Value = "missing_authorization_key")]
            MissingAuthorizationKey = 1,

            /// <summary>
            /// Enum InvalidAuthorizationKey for value: invalid_authorization_key
            /// </summary>
            [EnumMember(Value = "invalid_authorization_key")]
            InvalidAuthorizationKey = 2
        }
        ...
        public AuthorizationError(MessageEnum? message = default(MessageEnum?))
        {
