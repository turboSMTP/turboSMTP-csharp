...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SuppressionFilterOrderRequestBody")]
    public partial class SuppressionFilterOrderRequestBody
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressionFilterOrderRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SuppressionFilterOrderRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressionFilterOrderRequestBody" /> class.
        /// </summary>
        ...
        public SuppressionFilterOrderRequestBody(DateTime from = default(DateTime), DateTime to = default(DateTime), string tz = default(string), string filter = default(string), List<SuppressionSource> filterBy = default(List<SuppressionSource>), bool? smartSearch = false, List<SuppressionRestriction> restrict = default(List<SuppressionRestriction>), SuppressionOrderBy? orderby = default(SuppressionOrderBy?), OrderType? ordertype = default(OrderType?))
        {
            this.From = from;
            this.To = to;
            this.Tz = tz;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SuppressionFilterOrderRequestBody {\n");
