...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubaccountCreateRequest")]
    public partial class SubaccountCreateRequest
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubaccountCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubaccountCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubaccountCreateRequest" /> class.
        /// </summary>
        ...
        /// <param name="password">subaccount password (required).</param>
        /// <param name="confirmPassword">subaccount confirm password (required).</param>
        public SubaccountCreateRequest(string email = default(string), string ip = default(string), string firstName = default(string), string lastName = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string companyName = default(string), string country = default(string), string region = default(string), string zipCode = default(string), string phoneNumber = default(string), bool policyAgree = default(bool), string siteUrl = default(string), string password = default(string), string confirmPassword = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for SubaccountCreateRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "ip" is required (not null)
            if (ip == null)
            {
                throw new ArgumentNullException("ip is a required property for SubaccountCreateRequest and cannot be null");
            }
            this.Ip = ip;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for SubaccountCreateRequest and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for SubaccountCreateRequest and cannot be null");
            }
            ...
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for SubaccountCreateRequest and cannot be null");
            }
            this.Password = password;
            // to ensure "confirmPassword" is required (not null)
            if (confirmPassword == null)
            {
                throw new ArgumentNullException("confirmPassword is a required property for SubaccountCreateRequest and cannot be null");
            }
