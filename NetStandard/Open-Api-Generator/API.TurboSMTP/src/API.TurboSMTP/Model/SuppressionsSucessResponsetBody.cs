...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SuppressionsSucessResponsetBody")]
    public partial class SuppressionsSucessResponsetBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressionsSucessResponsetBody" /> class.
        /// </summary>
        /// <param name="count">count.</param>
        /// <param name="results">results.</param>
        public SuppressionsSucessResponsetBody(int count = default(int), List<Suppression> results = default(List<Suppression>))
        {
            this.Count = count;
        ...
        public List<Suppression> Results { get; set; }
