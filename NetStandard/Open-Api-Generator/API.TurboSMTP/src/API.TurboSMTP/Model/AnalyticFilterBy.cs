...
namespace API.TurboSMTP.Model
{
    ...
    /// Filter by
    /// </summary>
    [DataContract(Name = "AnalyticFilterBy")]
    public partial class AnalyticFilterBy
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyticFilterBy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public AnalyticFilterBy()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnalyticFilterBy {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
