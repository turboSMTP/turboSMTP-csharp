...
namespace API.TurboSMTP.Model
{
    ...
    /// SubaccountIP
    /// </summary>
    [DataContract(Name = "SubaccountIP")]
    public partial class SubaccountIP
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubaccountIP" /> class.
        /// </summary>
        /// <param name="ip">IP address to use for sending emails..</param>
        public SubaccountIP(string ip = default(string))
        {
            this.Ip = ip;
        }
