...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmailValidatorListEmailDetails")]
    public partial class EmailValidatorListEmailDetails
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailValidatorListEmailDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailValidatorListEmailDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailValidatorListEmailDetails" /> class.
        /// </summary>
        ...
        /// <param name="accountId">Email validator account id..</param>
        /// <param name="createdAt">The date time the email was inserted into turboSMTP database after being validated..</param>
        /// <param name="didYouMean">Suggestive Fix for an email typo.</param>
        /// <param name="id">Email Id..</param>
        /// <param name="listId">List Id..</param>
        public EmailValidatorListEmailDetails(string email = default(string), StatusEnum? status = default(StatusEnum?), SubStatusEnum? subStatus = default(SubStatusEnum?), bool freeEmail = default(bool), string domain = default(string), int? domainAgeDays = default(int?), string smtpProvider = default(string), bool mxFound = default(bool), string mxRecord = default(string), int accountId = default(int), string createdAt = default(string), string didYouMean = default(string), int id = default(int), int listId = default(int))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for EmailValidatorListEmailDetails and cannot be null");
            }
            this.Email = email;
            this.Status = status;
        ...
        /// <summary>
        /// Email validator account id.
        /// </summary>
        /// <value>Email validator account id.</value>
        /// <example>20823223</example>
        [DataMember(Name = "account_id", EmitDefaultValue = false)]
        public int AccountId { get; set; }

        /// <summary>
        /// The date time the email was inserted into turboSMTP database after being validated.
        /// </summary>
        /// <value>The date time the email was inserted into turboSMTP database after being validated.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailValidatorListEmailDetails {\n");
