...
namespace API.TurboSMTP.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            //Mod
            //BasePath = "https://pro.api.serversmtp.com/api/v2"; //pro
            //BasePath = "http://185.228.39.82:8084/api/v2"; //Radwan
            BasePath = "https://staging.api.serversmtp.com/api/v2"; //Staging
            ...
            {
                {
                    ...
                    //    {"description", "turboSMTP Radwan Server"},
                    //}
                    //STAGING
                    new Dictionary<string, object> {
        ...
        public Configuration(
            ...
            string basePath = "https://pro.api.serversmtp.com/api/v2") : this()
        {
        ...
        {
            string report = "C# SDK (API.TurboSMTP) Debug Report:\n";
