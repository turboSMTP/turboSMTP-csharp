...
namespace API.TurboSMTP.Model
{
    ...
    public partial class Subaccount
    {
        ...
        /// <param name="firstName">subaccount owner first name.</param>
        /// <param name="lastName">subaccount owner last name.</param>
        ...
        /// <param name="policyAgree">Policy must be agreed in order to be able to create a subaccount..</param>
        /// <param name="siteUrl">Website.</param>
        public Subaccount(string email = default(string), string ip = default(string), bool active = default(bool), int subaccountId = default(int), int parentId = default(int), string firstName = default(string), string lastName = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string companyName = default(string), string country = default(string), string region = default(string), string zipCode = default(string), string phoneNumber = default(string), bool policyAgree = default(bool), string siteUrl = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for Subaccount and cannot be null");
            }
            this.Email = email;
            this.Active = active;
            this.Ip = ip;
        ...
        /// <example>true</example>
        [DataMember(Name = "policy_agree", EmitDefaultValue = true)]
