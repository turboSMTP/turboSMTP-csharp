...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SuppressionUploadBadRequestResponseBody")]
    public partial class SuppressionUploadBadRequestResponseBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressionUploadBadRequestResponseBody" /> class.
        /// </summary>
        /// <param name="res">res.</param>
        public SuppressionUploadBadRequestResponseBody(string res = default(string))
        {
            this.Res = res;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SuppressionUploadBadRequestResponseBody {\n");
