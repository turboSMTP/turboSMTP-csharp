...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SuppressionFilterOrderPageRequestBody")]
    public partial class SuppressionFilterOrderPageRequestBody
    {
        ...
        public SuppressionOrderBy? Orderby { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressionFilterOrderPageRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SuppressionFilterOrderPageRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SuppressionFilterOrderPageRequestBody" /> class.
        /// </summary>
        ...
        /// <param name="limit">The numbers of rows per page to return (default to 10).</param>
        public SuppressionFilterOrderPageRequestBody(DateTime from = default(DateTime), DateTime to = default(DateTime), string tz = default(string), string filter = default(string), List<SuppressionSource> filterBy = default(List<SuppressionSource>), bool? smartSearch = false, List<SuppressionRestriction> restrict = default(List<SuppressionRestriction>), SuppressionOrderBy? orderby = default(SuppressionOrderBy?), OrderType? ordertype = default(OrderType?), int? page = 1, int? limit = 10)
        {
            this.From = from;
            this.To = to;
            this.Tz = tz;
        ...
        /// </summary>
        /// <value>The numbers of rows per page to return</value>
        /// <example>10</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SuppressionFilterOrderPageRequestBody {\n");
