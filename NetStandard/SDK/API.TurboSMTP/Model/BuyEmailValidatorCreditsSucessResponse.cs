...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BuyEmailValidatorCreditsSucessResponse")]
    public partial class BuyEmailValidatorCreditsSucessResponse
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BuyEmailValidatorCreditsSucessResponse" /> class.
        /// </summary>
        /// <param name="url">Url to complete payment.</param>
        public BuyEmailValidatorCreditsSucessResponse(string url = default(string))
        {
            this.Url = url;
        }
        ...
        /// </summary>
        /// <value>Url to complete payment</value>
        /// <example>http://bs.dev.serversmtp.com/index.php/guest/payment_information/form/amsyUJvFeW0fkjLqbcTKMCBRZDi2AdIH</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BuyEmailValidatorCreditsSucessResponse {\n");
