...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlertListSucessResponsetBody")]
    public partial class AlertListSucessResponsetBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlertListSucessResponsetBody" /> class.
        /// </summary>
        /// <param name="count">count.</param>
        /// <param name="results">results.</param>
        public AlertListSucessResponsetBody(int count = default(int), List<Alert> results = default(List<Alert>))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlertListSucessResponsetBody {\n");
