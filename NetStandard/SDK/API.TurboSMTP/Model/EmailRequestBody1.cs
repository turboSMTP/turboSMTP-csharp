...
namespace API.TurboSMTP.Model
{
    ...
    /// EmailRequestBody1
    /// </summary>
    [DataContract(Name = "EmailRequestBody_1")]
    public partial class EmailRequestBody1
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailRequestBody1" /> class.
        /// </summary>
        /// <param name="email">email address to validate.</param>
        public EmailRequestBody1(string email = default(string))
        {
            this.Email = email;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailRequestBody1 {\n");
