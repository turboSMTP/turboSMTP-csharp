...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthenticationLoginSucessResponsetBody")]
    public partial class AuthenticationLoginSucessResponsetBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticationLoginSucessResponsetBody" /> class.
        /// </summary>
        /// <param name="auth">API Key to be used in authorization header.</param>
        public AuthenticationLoginSucessResponsetBody(string auth = default(string))
        {
            this.Auth = auth;
        }
        ...
        /// </summary>
        /// <value>API Key to be used in authorization header</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticationLoginSucessResponsetBody {\n");
