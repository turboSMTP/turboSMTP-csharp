...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SendBadRequestResponseBody")]
    public partial class SendBadRequestResponseBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendBadRequestResponseBody" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="errors">errors.</param>
        public SendBadRequestResponseBody(string message = default(string), List<string> errors = default(List<string>))
        {
        ...
        /// Gets or Sets Errors
        /// </summary>
        /// <example>[&quot;missing or not valid sender email (from)&quot;]</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SendBadRequestResponseBody {\n");
