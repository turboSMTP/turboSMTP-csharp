...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BuyEmailValidatorCreditsRequest")]
    public partial class BuyEmailValidatorCreditsRequest
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BuyEmailValidatorCreditsRequest" /> class.
        /// </summary>
        /// <param name="amount">Amount of money to use for purchase.</param>
        public BuyEmailValidatorCreditsRequest(int amount = default(int))
        {
            this.Amount = amount;
        }
        ...
        /// </summary>
        /// <value>Amount of money to use for purchase</value>
        /// <example>320</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BuyEmailValidatorCreditsRequest {\n");
