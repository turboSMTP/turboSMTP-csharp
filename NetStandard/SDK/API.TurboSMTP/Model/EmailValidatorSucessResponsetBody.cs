...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmailValidatorSucessResponsetBody")]
    public partial class EmailValidatorSucessResponsetBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailValidatorSucessResponsetBody" /> class.
        /// </summary>
        /// <param name="count">count.</param>
        /// <param name="results">results.</param>
        public EmailValidatorSucessResponsetBody(int count = default(int), List<EmailValidatorList> results = default(List<EmailValidatorList>))
        {
            this.Count = count;
        ...
        public List<EmailValidatorList> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailValidatorSucessResponsetBody {\n");
