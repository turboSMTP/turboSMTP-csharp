...
namespace API.TurboSMTP.Model
{
    ...
    public partial class Alert
    {
        ...
        public Alert(string email = default(string), int percentage = default(int), int id = default(int))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for Alert and cannot be null");
            }
            this.Email = email;
