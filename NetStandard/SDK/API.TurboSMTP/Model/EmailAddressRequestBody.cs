...
namespace API.TurboSMTP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmailAddressRequestBody")]
    public partial class EmailAddressRequestBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailAddressRequestBody" /> class.
        /// </summary>
        /// <param name="email">email address to validate.</param>
        public EmailAddressRequestBody(string email = default(string))
        {
            this.Email = email;
        }
        ...
        /// <example>developer@yourcompany.com</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailAddressRequestBody {\n");
