...
namespace API.TurboSMTP.Model
{
    ...
    /// SubaccountBase
    /// </summary>
    [DataContract(Name = "SubaccountBase")]
    public partial class SubaccountBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubaccountBase" /> class.
        /// </summary>
        ...
        public SubaccountBase(string ip = default(string), string firstName = default(string), string lastName = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string companyName = default(string), string country = default(string), string region = default(string), string zipCode = default(string), string phoneNumber = default(string), bool policyAgree = default(bool), string siteUrl = default(string))
        {
            this.Ip = ip;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubaccountBase {\n");
