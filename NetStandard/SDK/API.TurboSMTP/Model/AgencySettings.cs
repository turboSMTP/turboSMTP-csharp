...
namespace API.TurboSMTP.Model
{
    ...
    /// AgencySettings
    /// </summary>
    [DataContract(Name = "AgencySettings")]
    public partial class AgencySettings
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgencySettings" /> class.
        /// </summary>
        ...
        public AgencySettings(string logoUrl = default(string), string agencyName = default(string), string agencyWebsite = default(string), string agencyFooter = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgencySettings {\n");
