...
namespace API.TurboSMTP.Model
{
    ...
    /// AlertBase
    /// </summary>
    [DataContract(Name = "AlertBase")]
    public partial class AlertBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlertBase" /> class.
        /// </summary>
        ...
        /// <param name="percentage">Percentage of usage that will trigger the alert.</param>
        public AlertBase(string email = default(string), int percentage = default(int))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for AlertBase and cannot be null");
            }
            this.Email = email;
        ...
        /// </summary>
        /// <value>Percentage of usage that will trigger the alert</value>
        /// <example>80</example>
